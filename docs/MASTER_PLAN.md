# Master Plan: "Himachal-Sahayata" Relief Platform

Welcome to the **Disaster Relief Resource Matcher** (Project: Himachal-Sahayata).  
This project is designed to win **Hack-O-Fest 2026** by leveraging local AI (Ollama) and a deep focus on the specific geographic challenges of **Himachal Pradesh**.
